#pragma checksum "D:\App3\thuchanh\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "277B12BF2A42B4CA3DFA33136CAF5651"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace thuchanh
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::thuchanh.Model.Thongtin dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::thuchanh.Model.Thongtin) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::thuchanh.Model.Thongtin)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::thuchanh.Model.Thongtin obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_anh(obj.anh, phase);
                        this.Update_Product(obj.Product, phase);
                        this.Update_Description(obj.Description, phase);
                    }
                }
            }
            private void Update_anh(global::System.String obj, int phase)
            {
        ...
        private class MainPage_obj13_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::thuchanh.Model.Anh dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::thuchanh.Model.Anh) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::thuchanh.Model.Anh)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::thuchanh.Model.Anh obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::thuchanh.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::thuchanh.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::thuchanh.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        this.Update_Thongtins(obj.Thongtins, phase);
                        this.Update_anhs(obj.anhs, phase);
                    }
                }
            }
            private void Update_Thongtins(global::System.Collections.ObjectModel.ObservableCollection<global::thuchanh.Model.Thongtin> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_anhs(global::System.Collections.Generic.List<global::thuchanh.Model.Anh> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            ...
            case 8: // MainPage.xaml line 30
                {
                    this.ProductBox = (global::Windows.UI.Xaml.Controls.TextBox)(target);
                }
                break;
            ...
            case 10: // MainPage.xaml line 36
                {
                    this.ImageBox = (global::Windows.UI.Xaml.Controls.ComboBox)(target);
                }
                break;
